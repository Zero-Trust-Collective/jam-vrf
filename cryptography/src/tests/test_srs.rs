...
fn test_pcs_params_serialization_flags() {
    ...
    let _: ring::PcsParams<BandersnatchSha512Ell2> = ring::PcsParams::<BandersnatchSha512Ell2>::deserialize_uncompressed(&mut &uncompressed[..])
        .expect("Failed to deserialize uncompressed parameters");
        
    let _: ring::PcsParams<BandersnatchSha512Ell2> = ring::PcsParams::<BandersnatchSha512Ell2>::deserialize_compressed(&mut &compressed[..])
